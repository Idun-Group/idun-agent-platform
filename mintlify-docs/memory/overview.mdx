...
<Tabs>
  ...
  <Tab title="Manager UI">
    <Steps>
      <Step title="Browse the backend catalog">
        ...
        ![Memory catalog](/images/ui/memory-catalog.png)
      </Step>
      <Step title="Add a backend">
        Click **+** on your backend and configure the connection details.
        ![Create PostgreSQL memory config](/images/ui/memory-create-postgres.png)
      </Step>
