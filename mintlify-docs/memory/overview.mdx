  ...
  <Tab title="Manager UI">
    <Steps>
      <Step title="Open memory">
        Navigate to **Memory** in the sidebar to see all configured memory backends.
        ![Memory list](/images/ui/memory-list.png)
      </Step>
      <Step title="Create a memory configuration">
        Click **Create** and fill in the configuration form. Select a backend from the dropdown: in-memory, SQLite, or PostgreSQL. For SQLite and PostgreSQL, provide the connection details.
      </Step>
      <Step title="Assign to an agent">
        Open your agent, edit it, and select the memory configuration from the memory section.
      </Step>
    </Steps>
  </Tab>
</Tabs>
