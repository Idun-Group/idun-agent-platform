...
This guide walks you through setting up LangSmith to add observability to your agents. Once enabled, you can track agent execution, view traces, and analyze performance in your LangSmith dashboard.
...
You will see detailed traces showing the execution run tree, LLM inputs/outputs, and latency information.
