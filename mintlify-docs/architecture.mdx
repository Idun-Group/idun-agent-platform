...
A Python SDK that wraps agent frameworks (LangGraph, Google ADK, Haystack) into production-ready FastAPI services. You provide your agent code and a configuration, and the engine adds streaming (AG-UI protocol), memory/checkpointing, observability, guardrails, MCP tool management, SSO, and messaging integrations.
...
<CardGroup cols={3}>
  <Card title="Supported frameworks" icon="layer-group" href="/frameworks/overview">
    LangGraph, Google ADK, and Haystack adapters.
  </Card>
