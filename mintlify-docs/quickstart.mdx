  ...
  <Tab title="Manager (recommended)">
    ...
    <Steps>
      ...
      <Step title="Create an agent">
        ...
        Log in (if you have not configured an auth provider yet, press **Login** to skip).
        Use the UI to create a new agent, select your framework (LangGraph or ADK), point it to your agent code, and start it.

        ![Agent creation wizard showing framework selection](/images/ui/agents-create-framework.png)
      </Step>
    </Steps>
  </Tab>
