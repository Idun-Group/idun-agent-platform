...
Add more MCP servers through the Manager UI to extend your agent's capabilities.
...
Deploy your own MCP servers for specialized functionality like database access, API integrations, or internal tools.
...
- **Monitoring**: Use [observability](/observability/overview) to track MCP server latency and identify performance bottlenecks
