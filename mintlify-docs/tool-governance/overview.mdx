  ...
  <Tab title="Manager UI">
    <Steps>
      <Step title="Open MCP servers">
        Navigate to **MCP Servers** in the sidebar to see all registered servers.
        ![MCP server list](/images/ui/mcp-list.png)
      </Step>
      <Step title="Create an MCP server">
        Click **Create** and fill in the configuration form. Select a transport type (stdio, SSE, or HTTP) and provide the corresponding connection details: command and args for stdio, or a URL for remote transports.
      </Step>
      <Step title="Assign to an agent">
        Open your agent, edit it, and select the MCP server from the MCP servers section.
      </Step>
    </Steps>
  </Tab>
</Tabs>
