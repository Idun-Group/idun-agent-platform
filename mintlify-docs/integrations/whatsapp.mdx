  ...
  <Tab title="Manager UI">
    <Steps>
      <Step title="Open the integrations list">
        In the Manager UI sidebar, click **Integrations**.

        ![Integrations list](/images/ui/integrations-list.png)
      </Step>

      <Step title="Create the WhatsApp integration">
        Click **Create**, select **WhatsApp**, and fill in the form:
        ...
        ![WhatsApp integration form](/images/ui/integrations-whatsapp-form.png)
      </Step>
