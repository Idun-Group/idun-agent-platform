...
keywords: ["authentication", "authorization", "SSO", "OIDC", "RBAC", "roles", "Google OAuth", "Okta", "Auth0", "Azure AD"]
---
...
Configure SSO through the Manager UI or directly in YAML:
...
The engine validates JWTs against any OIDC-compliant provider's JWKS endpoint. Tested providers include:

- **Google Workspace** (issuer: `https://accounts.google.com`)
- **Okta** (audience: typically `api://default` for client credentials tokens)
- **Auth0**
- **Microsoft Azure AD**
