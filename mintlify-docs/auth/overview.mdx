...
<Tabs>
  ...
  <Tab title="Manager UI">
    The Manager UI provides pages for managing SSO configuration and workspace users.

    **SSO configurations**

    Navigate to **Settings > SSO** to view and create SSO configurations.

    ![SSO configurations list](/images/ui/sso-list.png)

    Create a new SSO config by providing the issuer URL, client ID, and optional domain or email allowlists.

    **User management**

    Navigate to **Settings > Users** to view all workspace members and their roles.
