...
from src import create_app, run_server, run_server_from_builder, ConfigBuilder
...
def load_and_modify_config():
    ...
    try:
        ...
        print(f"⚠️  Config file not found at {basic_config_path}, using basic config instead")
...
def save_and_load_config():
    ...
    print(f"📂 Configuration reloaded from file")
...
def main():
    ...
    if example == "basic":
        ...
        print("❌ Unknown example. Use: basic, environment, load_modify, conditional, save_load, direct_run, or agent_init")
        return
