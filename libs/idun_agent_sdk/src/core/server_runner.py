"""
Server Runner for Idun Agent SDK

This module provides convenient functions to run FastAPI applications created with
the Idun Agent SDK. It handles common deployment scenarios and provides sensible defaults.
"""
...
def run_server(
    ...
    """
    Run a FastAPI application created with Idun Agent SDK.
    ...
    print(f"🌐 Starting Idun Agent SDK server on http://{host}:{port}")
