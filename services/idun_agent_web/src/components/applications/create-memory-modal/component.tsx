...
interface CreateMemoryModalProps {
  isOpen: boolean;
  onClose: () => void;
  onCreate: (data: { framework: string, provider: string, config: any, name: string, description: string }) => Promise<void>; // Updated to Promise
...
export const CreateMemoryModal: React.FC<CreateMemoryModalProps> = ({ isOpen, onClose, onCreate, initialFramework }) => {
  ...
  return (
    <Overlay onClick={onClose}>
      <ModalContainer onClick={e => e.stopPropagation()}>
        ...
        <Header>
          <div>
            <Title>Create Memory Store</Title>
            <Subtitle>Configure a new state persistence layer.</Subtitle>
          </div>
