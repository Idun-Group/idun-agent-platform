...
class TenantEntity(BaseModel):
    ...
    def can_create_agent(self) -> bool:
        ...
        return (
            self.status == TenantStatus.ACTIVE and self.current_agents < self.max_agents
        )
    ...
    def can_run_agent(self) -> bool:
        ...
        return (
            ...
            and self.current_runs_this_month < self.max_runs_per_month
        )
    ...
    def increment_usage(
        self, agents: int = 0, runs: int = 0, storage_mb: float = 0
    ) -> None:
