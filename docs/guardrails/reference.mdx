...
description: "Reference for all 15 guardrail types available in Idun Engine, including configuration fields and usage positions."
...
<Card title="Guardrails overview" icon="shield" horizontal href="/guardrails/overview">
