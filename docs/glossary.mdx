...
Idun Agent Platform ships as a small set of packages with a clear relationship. This page defines each one and explains which install path you actually want to follow.
