...
This doc aim to show you how to add any MCP server into Idun Platform. (self-hosted or available online)
And how to giev your agents access to your MCP server.
