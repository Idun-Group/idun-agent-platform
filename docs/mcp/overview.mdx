...
<Cards>
  <Card title="Docker MCP toolkit" icon="docker" href="/mcp/docker-toolkit">
    Pre-built MCP servers packaged as Docker containers. Pull, configure, and use without writing server code.
  </Card>
  <Card title="Custom MCP servers" icon="code" href="/mcp/docker-toolkit#advanced-configuration">
