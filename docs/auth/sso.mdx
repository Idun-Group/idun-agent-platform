...
sso:
  ...
  client_id: "..."
  allowed_domains:
    - "yourcompany.com"   # everyone with a @yourcompany.com Google account
  allowed_emails:
    - "external-auditor@partner.com"   # plus this one outside contractor
```
...
- **Microsoft Entra ID / Azure AD** — multi-tenant `https://login.microsoftonline.com/common`, or single-tenant `https://login.microsoftonline.com/<tenant-uuid>`
- **Okta** — issuer typically `https://<your-domain>.okta.com/oauth2/default`; audience usually `api://default`
