...
| `IDUN_DEPLOYMENT_TYPE` | Tag events with `cloud` or `self-hosted` |
...
For the full list of browser events captured and PostHog masking conventions, see [Telemetry events](/observability/telemetry-events).
