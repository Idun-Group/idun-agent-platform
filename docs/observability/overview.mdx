...
<Tabs>
  ...
  <Tab title="Config file">
    ...
    The YAML stays a list because that's what the engine schema requires, but the standalone admin UI attaches exactly one provider per agent. See the provider-specific pages for the full list of fields each provider requires.
  </Tab>
</Tabs>
