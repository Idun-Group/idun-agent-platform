  ...
  <Tab title="Admin UI">
    <Steps>
      <Step title="Open the integrations admin page">
        ...
        {/* VERIFY: confirm Google Chat appears in the channel catalog for this release. */}
      </Step>
      ...
      <Step title="Save">
        ...
        {/* VERIFY: confirm reload pipeline registers Google Chat webhook handler at runtime. */}
      </Step>
    </Steps>
  </Tab>
