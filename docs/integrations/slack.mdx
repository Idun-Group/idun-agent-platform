  ...
  <Tab title="Admin UI">
    <Steps>
      <Step title="Open the integrations admin page">
        ...
        {/* VERIFY: confirm channel catalog entries shown in standalone admin UI for this release. */}
      </Step>
      ...
      <Step title="Create the Slack integration">
        ...
        ![Add Slack integration](/images/ui/admin-integrations-slack.png)
      </Step>
      ...
      <Step title="Save">
        ...
        {/* VERIFY: confirm reload pipeline registers Slack webhook handler at runtime. */}
      </Step>
    </Steps>
  </Tab>
