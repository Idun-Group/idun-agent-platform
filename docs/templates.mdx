...
<Steps>
  ...
  <Step title="Run it">
    ...
    Runs migrations, seeds the DB from the template's `config.yaml`, opens the browser at `http://localhost:8000/`, and serves the standalone app. Subsequent boots just need `idun serve`.
  </Step>
</Steps>
